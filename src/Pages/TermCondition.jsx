  ...
  return (
    ...
    >
      <div className="container">
        <div className="bg-white p-4 mb-2 rounded-lg shadow-xl py-8">
          <h2 className="mb-2 text-2xl">
            <strong>Terms and Conditions</strong>
          </h2>

          <p>Welcome to Umrah-taxi!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of Umrah-taxi Service's Website, located at Umrah-taxi.com.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Umrah-taxi if you do not agree to
          ...
          <p>
            We employ the use of cookies. By accessing Umrah-taxi, you agreed to
            use cookies in agreement with the Umrah-taxi Service's Privacy
            Policy.{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, Umrah-taxi Service and/or its licensors own
            the intellectual property rights for all material on Umrah-taxi. All
            intellectual property rights are reserved. You may access this from
            Umrah-taxi for your own personal use subjected to restrictions set
            in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from Umrah-taxi</li>
            <li>Sell, rent or sub-license material from Umrah-taxi</li>
            <li>Reproduce, duplicate or copy material from Umrah-taxi</li>
            <li>Redistribute content from Umrah-taxi</li>
          </ul>
          ...
          <p>
            ...
            Umrah-taxi Service does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of Umrah-taxi Service,its agents and/or
            ...
            applicable laws, Umrah-taxi Service shall not be liable for the
          ...
          <p>
            Umrah-taxi Service reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant Umrah-taxi Service a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Umrah-taxi
            Service; and (d) the link is in the context of general resource
            information.
          </p>
          ...
          <p>
            ...
            sending an e-mail to Umrah-taxi Service. Please include your name,
          ...
          <p>
            No use of Umrah-taxi Service's logo or other artwork will be allowed
