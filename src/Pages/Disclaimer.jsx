      ...
      <div className="container">
        <div className="bg-white p-4 mb-2 rounded-lg shadow-xl py-8">
          <h1 className=" font-bold my-2 text-2xl">
            Disclaimers for Umrah-taxi
          </h1>

          <p>
            All the information on this website - Umrah-taxi.com - is published
            in good faith and for general information purpose only. Umrah-taxi
            ...
            information you find on this website (Umrah-taxi), is strictly at
            your own risk. Umrah-taxi will not be liable for any losses and/or
